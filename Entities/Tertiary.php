...
class Tertiary extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Tertiary Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Tertiary Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Tertiary Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
