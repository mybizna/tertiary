...
class LearnerCourse extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Learning Course Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Learning Course Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Learning Course Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
