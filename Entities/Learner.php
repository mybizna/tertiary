...
class Learner extends BaseModel
{
     ...
     * @var string
     */
    protected $table = "tertiary_student";
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Learning Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Learning Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Learning Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
