...
class Course extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Course Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Course Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Course Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
