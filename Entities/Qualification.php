...
class Qualification extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Qualification Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Qualification Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Qualification Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
