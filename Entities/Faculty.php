...
class Faculty extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Faculty Name', 'class' => 'col-span-full', 'fields' => ['name']],
            ['label' => 'Faculty Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['published']],
            ['label' => 'Faculty Description', 'class' => 'col-span-full', 'fields' => ['description']],
        ];
